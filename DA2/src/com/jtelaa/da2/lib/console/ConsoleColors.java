...
public enum ConsoleColors {
     ...
     * @param escape
     */
    ConsoleColors(String escape) {
        this.escape = escape.toCharArray();
    }

    /** */
    public String getColor() { return new String(escape); }
    /** */
    public String getEscape() { return new String(escape); }

    public boolean equals(ConsoleColors color) { return getColor().equalsIgnoreCase(color.getColor()); }

    /**
     * Runs through all of the options and prints them
     */
    public static void main(String[] args) {
        for (ConsoleColors e : values()) {
            if (!e.equals(RESET)) {
                System.out.println(e.getColor() + "Test12345" + RESET.getEscape());
            }
        }
    }
