 ...
 *  thx so much https://github.com/KeywordDomains/TypoGenerator
 *
 ...
 */
 var generateTypos = function(keywords, options) {
	...
	// http://web-professor.net/scripts/typo/TypoGenerator.txt
	...
	function doubleCharTypos(word) {
		...
		for(var i = 0; i < length; i++) {
			var tempWord = word.substr(0, (i + 1));
				tempWord += word[i];
